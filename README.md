...
This project was inspired by [LibreTV](https://github.com/LibreSpark/LibreTV/tree/main). I found [LibreTV](https://github.com/LibreSpark/LibreTV/tree/main) useful but requiring a backend, so I wanted to create a backend-free version. Thus, this project was born through my conversations with AIs... Thanks to that project for the creative inspiration.
